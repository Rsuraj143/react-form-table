...
const EditUser = () => {
  ...
  return (
    <div className="container-fluid">
      ...
      <h2 className='text-center border p-2 mb-3 bg-light'>Edit User</h2>
        ...
        <Formik initialValues={
              ...
              onSubmit={values=>{
                ...
                if(!name || !email || !password || !city || !state || !date || !age || !address || !profile || !status){
                      ...
                      <Form>
                  {
                      <div>
                          <dl>
                              ...
                              <dd className='text-center'><button className='btn btn-success mt-2' type="button"> Submit</button></dd>
                          </dl>
